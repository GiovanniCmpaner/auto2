static auto createShaderProgram(const std::string& vs, const std::string& fs) -> GLuint
{
...
static auto createShaderFromString(const std::string& source, GLenum type) -> GLuint
{
...
static auto printError(GLuint object) -> void
{
    auto length{ 0 };
